...
namespace CentralService.Models
{
    public class ExtraPromotionModel
    {
        ...
        public string pro_start_time { get; set; } = Convert.ToDateTime("00:00").ToString("HH:mm:ss");
        [Display(Name = "วันที่สิ้นสุด")]
        public string pro_end_date { get; set; }
        public string pro_end_time { get; set; } = Convert.ToDateTime("23:59").ToString("HH:mm:ss");
        ...
        // เงื่อนไขรอบเวลา
        public int pro_condition_time_id { get; set; } = 3; // defualt
        ...
        public string pro_condition_time_start { get; set; } = Convert.ToDateTime("00:00").ToString("HH:mm:ss");
        public string pro_condition_time_end { get; set; } = Convert.ToDateTime("23:59").ToString("HH:mm:ss");
        //1 รอบสัปดาห์ ,//2 รอบเดือน
        public string ProConditionWeekStart { get; set; } = Convert.ToDateTime("00:00").ToString("HH:mm:ss");

        public string ProConditionWeekTimeEnd { get; set; } = Convert.ToDateTime("23:59").ToString("HH:mm:ss");

        public string ProConditionMonthStart { get; set; } = Convert.ToDateTime("00:00").ToString("HH:mm:ss");

        public string ProConditionMonthEnd { get; set; } = Convert.ToDateTime("23:59").ToString("HH:mm:ss");

        // สาขาที่ร่วมรายการ
        public List<DealerMasterModel> Dealers { get; set; }
        ...
        // อนุญาต
        public bool allow_promotion { get; set; } = true;
        //0 = ไม่ได้, 1 = ได้
        ...
        //โปรโมชั่นจะใช้กับ :
        public int pro_group_used_id { get; set; } = 1; // defualt
        ...
        //เงื่อนไขจำนวนสินค้า
        public int pro_give_type_id { get; set; } = 1; // defualt
        ...
        public int pro_discount_id { get; set; } = 1;// defualt
        public double pro_discount_num { get; set; }
        public double pro_discount_rate { get; set; }
        public int pro_give_free_amount { get; set; } = 1;
        ...
        #region pro_group_used_id == 5 || Model.pro_group_used_id == 6
        ...
        public ExcelMgmtModel Excel_Mgmt { get; set; }
