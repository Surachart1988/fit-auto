            ...
            this.columns = [
                {
                    ...
                    "render": function render(data, type, row) {
                        return "<a href=\"" + _this2.editUrl + "?id=" + row.pro_id + "&mode=v\" >" + row.pro_name + "</a>";
                    }
                },
                {
                    "data": "pro_id",
                    ...
                    "render": function render(data, type, row) {
                        return "<a href=\"" + _this2.viewstep2Url + "?id=" + row.pro_id + "&mode=c\" >เงื่อนไข</a>";
                    }
                },
                {
                    "data": "pro_start_date",
                ...
                },
                {
                    ...
                    "orderable": false,
                    "render": function render(data, type, row) {
                        return "<a onclick=ViewProitems('" + data + "')  style='cursor: pointer;'>" +
                ...
                },
                {
                    ...
                    "orderable": false,
                    "render": function render(data, type, row) {
                        if (row.check_expired === "No" && row.deleted === false) {
                ...
                },
                {
                    ...
                    "orderable": false,
                    "render": function render(data, type, row) {
                        if (type === 'display') {// deleted = false = 0 = เปิดการใช้งาน, true = 1 = ปิดการใช้งาน
                            if (row.deleted === true || row.check_expired === "Yes") {
                                return "<span style='color: #2E92CF;'>-</span>";
                            } else {
