...
namespace newHQ.Controllers.SystemData
{
    public class BranchController : Controller
    {
        ...
        public ActionResult Create(int id = 0, string mode = "")
        {
            ...
            model.dealercode = _service.GetNewCode();
            if (id != 0)
            {
        ...
        public ActionResult Create(BranchModel model)
        {
            ...
            try
            {
                ...
                {
                    if (_service.AddUpdate(model, ref doc_no_run) > 0)
                    {
                        return RedirectToAction("Create", new { id = doc_no_run, mode = "v" });
                    }
                    else
                    {
