...
namespace PosData.Models
{
    ...
    public partial class SB_Product
    {
        ...
        public Nullable<int> package_day { get; set; }
        public Nullable<int> package_free { get; set; }
        public string package_pro_code { get; set; }
        public string product_type_service { get; set; }
        public Nullable<double> recal_vat_movement { get; set; }
        public Nullable<double> recal_vat_avgcost { get; set; }
        public Nullable<double> recal_novat_movement { get; set; }
        public Nullable<double> recal_total_movement { get; set; }
