class CreditCardModal {
    ...
    init() {
        ...
        this.txtApprCode.keyup(() => {
            if (me.txtApprCode.val().length < 6) {
                me.txtApprCodeIsValid.show()
            }
            else
                me.txtApprCodeIsValid.hide()
        })

        this.txtCreditNumber.keyup(() => {
            ...
            else if (me.crType && me.crType != 'unknown' && me.crType != 'uatp')
                me.txtCreditNumberIsValid.hide()
        })
