...
var BlueCardModalPartialPartial = function () {
    function BlueCardModalPartialPartial() {
        _classCallCheck(this, BlueCardModalPartialPartial);
        ...
        this.blueCardRedeemModal = $('#PartialblueCardRedeemModal');
        ...
        //this.hidExRateby = $('#ExRateby');
        //this.hidBlueCard_RewardPoint = $('#BlueCard_RewardPoint');
        //this.hidBlueCard_Money = $('#BlueCard_Money');
        ...
        this.getUrl = null;
        this.getUrl2 = null;
        this.urlAddSession = null;
        this.urlPrintReport = null;
        this.txtTotalAmount = $('#TotalAmount');
    }

    _createClass(BlueCardModalPartialPartial, [{
        key: 'init',
        value: function init() {
            var me = this;
            ...
            this.blueCardRedeemModal.on('shown.bs.modal', function () {
                ...
                $('#BlueCardType1').addClass('btn btn-success');
            });
            ...
            this.txtUsePoint.keyup(function () {
                ...
                //var useRatebyFitAuto = me.hidExRateby.val();
                //var FitAuto__RewardPoint = me.hidBlueCard_RewardPoint.val();
                //var FitAuto_Money = me.hidBlueCard_Money.val();
                ...
                if (+me.inputBalancePoint.getRawValue() < txtUsePoint) {
                    ...
                    if (+me.hidMIN_Redeem_Point.val() > txtUsePoint) {
                        ...
                        me.txtBlueCardMoney.val((txtUsePoint * Ratio_Point).toFixed(2));
            ...
            $.ajax({
                ...
                success: function success(resp) {
                    if (resp.Code != "00") {
                        ...
                        //me.hidExRateby.val(resp.Data.ExRateby);
                        //me.hidBlueCard_RewardPoint.val(resp.Data.BlueCard_RewardPoint);
                        //me.hidBlueCard_Money.val(resp.Data.BlueCard_Money);
                ...
                success: function success(resp) {
                    ...
                    if (resp.Code == "00") {
                        var data = {
                            ...
                            PaymentType: "BlueCardPayment",
                            Money: money,
                            BlueCardNo: me.txtBlueCardNo.val(),
                            BlueCardMobile: me.txtBlueCardMobile.val(),
                            PaymentNumberId: me.txtBlueCardNo.val(),
                            PaymentTotal: $('#txtPaymentMoney').val(),
                            note: me.txtNote.val()
                        };
                        $.post(me.urlAddSession,
                            data,
                            function (result) {
                                ...
                                if (result.Success) {
                                    ...
                                    $('#PartialblueCardRedeemModal').hide();
                                } else {
    ...
    return BlueCardModalPartialPartial;
}();