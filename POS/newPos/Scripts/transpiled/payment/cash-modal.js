...
var CashModal = function () {
    ...
    _createClass(CashModal, [{
        ...
        value: function init() {
            ...
            this.txtPaymentCash.click(function () {
                if (+$(this).val() == 0) {
                    $(this).val('');
                }
            });
            ...
            this.btnReceiveMoney.click(function () {
                ...
                me.addRowToDt(me.modalName, cashAmount, me.txtChangeMoney.val(), me.txtNote.val());
            });

            this.cashModal.on('shown.bs.modal', function () {
                if (me.indexForm.status == 'add') me.txtPaymentCash.val('0');
        ...
        key: 'addRowToDt',
            value: function addRowToDt(paymentType, money, moneyChange, note) {
            var me = this;
            var oldMoney = 0;
